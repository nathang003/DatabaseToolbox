...
using ToolboxWebApiLibrary.Models;
...
public class HomeController : Controller
{
                        ...
                        MicrosoftIdentityConsentAndConditionalAccessHandler consentHandler)
    {
        ...
        _graphScopes = configuration.GetValue<string>("MicrosoftGraph:Scopes")?.Split(' ');
    }
    ...
    {
        var accessToken = _tokenAcquisition.GetAccessTokenForUserAsync(new string[] { "user.read" });
        return View();
    }
